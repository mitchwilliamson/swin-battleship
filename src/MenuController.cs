...
static class MenuController
{
	...
	private const int MAIN_MENU_PLAYER_SCORES_BUTTON = 3;
	private const int MAIN_MENU_QUIT_BUTTON = 4;

	private const int SETUP_MENU_EASY_BUTTON = 0;
	private const int SETUP_MENU_MEDIUM_BUTTON = 1;
	private const int SETUP_MENU_HARD_BUTTON = 2;
	private const int SETUP_MENU_QUICKPLAY_BUTTON = 3;
	...
	private static void PerformMainMenuAction(int button)
	{
		switch (button) {
			...
			case MAIN_MENU_TOP_SCORES_BUTTON:
				...
				break;
			case MAIN_MENU_PLAYER_SCORES_BUTTON:
				GameController.AddNewState(GameState.ViewingPlayerScores);
				break;
	...
	private static void PerformSetupMenuAction(int button)
	{
		switch (button) {
			...
			case SETUP_MENU_HARD_BUTTON:
				...
				break;
            case SETUP_MENU_QUICKPLAY_BUTTON:
                GameController.ToggleQuickPlay();
                break;
        }
